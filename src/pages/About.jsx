    ...
    <div className="work-container">
      ...
      <Container className="works-container about-container">
        ...
        <div className="about-info-container" data-aos="fade-right">
          ...
          <p>
            I’m usually a fun person to be around. I make sure I’m always caught
            up with current news and trends in fields of my interest. I have a
            great sense of humor, I can make people laugh and know how to take a
            joke on myself.
          </p>
          <p>
