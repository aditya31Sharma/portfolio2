...
const Hero = () => {
  return (
    <div className="hero-section">
      <Container className="container" data-aos="fade-right">
        <h1 className="title">
          Ideate. Wireframe.
          <br />
          Prototype.
      ...
      <div className="hero-image-container">
        ...
        <div className="social-links-hero-image" data-aos="zoom-out-right">
        ...
        <Container className="hero-content-container" data-aos="fade-right">
