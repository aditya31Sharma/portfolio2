  ...
  return (
    <>
      <div className="glance-container">
        <p data-aos="fade">Let's have a glance at my work</p>
        <div className="work-image-container">
          <Container className="work-content-container">
            <div className="grad-overlay-content-container" data-aos="fade-right">
              <p>Includes:</p>
              <h2>UX Design Portfolio</h2>
              <h3>Visual/UI Design</h3>
              <h4>Programming</h4>
              <Link to="/myworks" className="hero-cta primary-cta work-cta">
