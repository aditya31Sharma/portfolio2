  ...
  return (
    <footer>
      <Container className="footer-container container">
        <div className="footer-text-container" data-aos="fade-up">
          <h3>Well,you've reached the end of this page</h3>
          <p>You can go ahead and explore further pages</p>
        </div>
        <div className="pages-container" data-aos="zoom-in-down">
        ...
        <div className="social-container" data-aos="zoom-in-up">
        ...
        <p data-aos="zoom-in-up">Made with <span role="img" aria-label="Heart">❤️</span> in React.js</p>
